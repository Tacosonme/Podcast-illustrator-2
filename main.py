...
def transcribe_audio_segments(job_dir, segment_files):
    """Transcribe audio segments using local Whisper model"""
    ...
    try:
        for idx, segment_file in enumerate(segment_files):
            ...
            transcript_data = {
                'segment_index': idx,
                'text': result['text'],
                'duration': None,  # Local whisper doesn't provide duration in same format
...
<body>
    <div class="container">
        ...
        <p><span class="badge">✨ 100% FREE - Local Whisper</span></p>
        ...
        <div class="features">
            ...
            <div class="feature">
                ...
                <p>Local Whisper model - completely free!</p>
            </div>
            <div class="feature">
...
def health():
    return jsonify({
        ...
        'platform': 'railway',
        'version': '2.0.0-free',
        'features': ['file_upload', 'audio_processing', 'local_whisper_transcription', 'health_check'],
        'message': 'Audio processing and FREE local Whisper transcription enabled!'
    })
